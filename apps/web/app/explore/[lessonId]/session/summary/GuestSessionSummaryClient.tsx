...
function GuestSessionSummaryContent() {
...
export default function GuestSessionSummaryClient() {
  return (
    <Suspense fallback={<div className="text-center py-20 text-sm text-slate-500">Memuat hasil...</div>}>
      <GuestSessionSummaryContent />
    </Suspense>
  );
}
